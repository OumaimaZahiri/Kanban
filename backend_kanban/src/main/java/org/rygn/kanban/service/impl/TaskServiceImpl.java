...
public class TaskServiceImpl implements TaskService {
	...
	/**
	 * @return the taskStatusRepository
	 */
	...
	/**
	 * @param taskStatusRepository the taskStatusRepository to set
	 */
	...
	/**
	 * @param taskTypeRepository the taskTypeRepository to set
	 */
